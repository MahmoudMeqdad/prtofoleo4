...
export const collectionsIndexContent = {
  ...
  heroSubtitle: {
    en: "Six original worlds of play — each with its own mood, color, and invitation to imagine.",
    ar: "ستة عوالم أصلية للعب — لكل منها مزاجه وألوانه ودعوته للخيال.",
  } satisfies LocalizedString,
  introHeading: {
    en: "Play, Curated with Care",
