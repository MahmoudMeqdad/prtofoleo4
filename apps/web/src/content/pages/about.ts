...
export const aboutContent = {
  ...
  missionBody: {
    en: "To craft playful experiences that help children discover the world through curiosity, creativity, and joy.",
    ar: "صنع تجارب لعب تساعد الأطفال على اكتشاف العالم عبر الفضول والإبداع والفرح.",
  },
  ...
  values: [
    {
      title: { en: "Imagination", ar: "الخيال" },
      body: {
        en: "Open-ended play over rigid scripts.",
        ar: "لعب مفتوح بدلاً من سيناريوهات جامدة.",
      },
    },
    {
      title: { en: "Clarity", ar: "الوضوح" },
      body: {
        en: "Honest communication with families and partners.",
        ar: "تواصل صادق مع العائلات والشركاء.",
      },
    },
    {
      title: { en: "Care", ar: "العناية" },
      body: {
        en: "Childhood comes first in every design decision.",
        ar: "الطفولة أولاً في كل قرار تصميمي.",
      },
    },
    {
      title: { en: "Originality", ar: "الأصالة" },
      body: {
        en: "We build our own visual language and stories.",
        ar: "نبني لغتنا البصرية وقصصنا الخاصة.",
      },
    },
  ],
  focusHeading: {
    en: "Play, Imagination, and Childhood",
    ar: "اللعب والخيال والطفولة",
  },
  focusBody: {
    en: "Every brand starts with how children feel while playing — curiosity, comfort, energy, and pride in making something their own.",
